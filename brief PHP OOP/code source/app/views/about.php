...
<h3 class="text-center">About Us</h3>
 <div class="p-5 m-auto">
   ...
   <h5>Best of what we got :</h5>
            <ul class=" m-4 ">
              <li class=" m-3 m-auto"><a class="link-primary text-decoration-none" href="#">Cool stuff</a></li>
              <li class="m-3 m-auto"><a class="link-primary text-decoration-none" href="#">Random stuff</a></li>
              <li class="m-3 m-auto"><a class="link-primary text-decoration-none" href="#">Team Random</a></li>
              <li class="m-3 m-auto"><a class="link-primary text-decoration-none" href="#">Stuff for developers</a></li>
              <li class="m-3 m-auto"><a class="link-primary text-decoration-none" href="#">Another one</a></li>
              <li class="m-3 m-auto"><a class="link-primary text-decoration-none" href="#">Last time</a></li>
            </ul>
